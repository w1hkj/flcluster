AC_DEFUN([AC_FLCLUSTER_NP_COMPAT], [
  ...
  if test "x$ac_cv_with_clock_gettime" = "xyes"; then
    AC_FLCLUSTER_SEARCH_LIBS([clock_gettime], [rt], [$other_libs])
  fi
  ...
  AC_FLCLUSTER_SEARCH_LIBS([dlopen], [dl], [$other_libs])
  AC_FLCLUSTER_SEARCH_LIBS([sem_unlink], [$sem_libs], [$other_libs])
  AC_FLCLUSTER_SEARCH_LIBS([sem_timedwait], [$sem_libs], [$other_libs])
