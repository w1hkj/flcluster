AC_DEFUN([AC_CHECK_FLTK], [
  ...
  *** contains fltk-config.
      ...
      FLCLUSTER_FLTK_API_MAJOR=${FLTK_VERSION%%.*}

      FLCLUSTER_FLTK_API_MINOR=${FLTK_VERSION#*.};
      FLCLUSTER_FLTK_API_MINOR=${FLCLUSTER_FLTK_API_MINOR%%.*}

      FLCLUSTER_FLTK_API_PATCH=${FLTK_VERSION#*.};
      FLCLUSTER_FLTK_API_PATCH=${FLCLUSTER_FLTK_API_PATCH#*.};
  ...
  *** To build $PACKAGE you need a FLTK version that provides API 1.3.
  ...
  AC_DEFINE_UNQUOTED([FLCLUSTER_FLTK_API_MAJOR], [$FLCLUSTER_FLTK_API_MAJOR], [FLTK API major version])
  AC_DEFINE_UNQUOTED([FLCLUSTER_FLTK_API_MINOR], [$FLCLUSTER_FLTK_API_MINOR], [FLTK API minor version])
  AC_DEFINE_UNQUOTED([FLCLUSTER_FLTK_API_PATCH], [$FLCLUSTER_FLTK_API_PATCH], [FLTK API patch])
