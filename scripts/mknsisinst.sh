...
flcluster_name=flcluster
flcluster_bin=flcluster.exe
...
def="-Dflcluster_NAME=$flcluster_name -Dflcluster_BINARY=$flcluster_bin -Dflcluster_VERSION=$PACKAGE_VERSION"
