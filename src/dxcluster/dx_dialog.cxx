...
Fl_Button *dxc_macro_9=(Fl_Button *)0;

Fl_Button *dxc_macro_10=(Fl_Button *)0;

Fl_Button *dxc_macro_11=(Fl_Button *)0;

Fl_Button *dxc_macro_12=(Fl_Button *)0;

Fl_Button *dxc_macro_13=(Fl_Button *)0;

Fl_Button *dxc_macro_14=(Fl_Button *)0;

Fl_Button *dxc_macro_15=(Fl_Button *)0;

Fl_Button *dxc_macro_16=(Fl_Button *)0;
...
Fl_Group *tabDXmacros=(Fl_Group *)0;
...
Fl_Input *mlabel_9=(Fl_Input *)0;

static void cb_mlabel_9(Fl_Input* o, void*) {
  progStatus.dxcm_label_9=o->value();
dxc_macro_9->label(progStatus.dxcm_label_9.c_str());
progStatus.changed=true;
}

Fl_Input2 *mtext_9=(Fl_Input2 *)0;

static void cb_mtext_9(Fl_Input2* o, void*) {
  progStatus.dxcm_text_9=o->value();
progStatus.changed=true;
}

Fl_Input *mlabel_10=(Fl_Input *)0;

static void cb_mlabel_10(Fl_Input* o, void*) {
  progStatus.dxcm_label_10=o->value();
dxc_macro_10->label(progStatus.dxcm_label_10.c_str());
progStatus.changed=true;
}

Fl_Input2 *mtext_10=(Fl_Input2 *)0;

static void cb_mtext_10(Fl_Input2* o, void*) {
  progStatus.dxcm_text_10=o->value();
progStatus.changed=true;
}

Fl_Input *mlabel_11=(Fl_Input *)0;

static void cb_mlabel_11(Fl_Input* o, void*) {
  progStatus.dxcm_label_11=o->value();
dxc_macro_11->label(progStatus.dxcm_label_11.c_str());
progStatus.changed=true;
}

Fl_Input2 *mtext_11=(Fl_Input2 *)0;

static void cb_mtext_11(Fl_Input2* o, void*) {
  progStatus.dxcm_text_11=o->value();
progStatus.changed=true;
}

Fl_Input *mlabel_12=(Fl_Input *)0;

static void cb_mlabel_12(Fl_Input* o, void*) {
  progStatus.dxcm_label_12=o->value();
dxc_macro_12->label(progStatus.dxcm_label_12.c_str());
progStatus.changed=true;
}

Fl_Input2 *mtext_12=(Fl_Input2 *)0;

static void cb_mtext_12(Fl_Input2* o, void*) {
  progStatus.dxcm_text_12=o->value();
progStatus.changed=true;
}

Fl_Input *mlabel_13=(Fl_Input *)0;

static void cb_mlabel_13(Fl_Input* o, void*) {
  progStatus.dxcm_label_13=o->value();
dxc_macro_13->label(progStatus.dxcm_label_13.c_str());
progStatus.changed=true;
}

Fl_Input2 *mtext_13=(Fl_Input2 *)0;

static void cb_mtext_13(Fl_Input2* o, void*) {
  progStatus.dxcm_text_13=o->value();
progStatus.changed=true;
}

Fl_Input *mlabel_14=(Fl_Input *)0;

static void cb_mlabel_14(Fl_Input* o, void*) {
  progStatus.dxcm_label_14=o->value();
dxc_macro_14->label(progStatus.dxcm_label_14.c_str());
progStatus.changed=true;
}

Fl_Input2 *mtext_14=(Fl_Input2 *)0;

static void cb_mtext_14(Fl_Input2* o, void*) {
  progStatus.dxcm_text_14=o->value();
progStatus.changed=true;
}

Fl_Input *mlabel_15=(Fl_Input *)0;

static void cb_mlabel_15(Fl_Input* o, void*) {
  progStatus.dxcm_label_15=o->value();
dxc_macro_15->label(progStatus.dxcm_label_15.c_str());
progStatus.changed=true;
}

Fl_Input2 *mtext_15=(Fl_Input2 *)0;

static void cb_mtext_15(Fl_Input2* o, void*) {
  progStatus.dxcm_text_15=o->value();
progStatus.changed=true;
}

Fl_Input *mlabel_16=(Fl_Input *)0;

static void cb_mlabel_16(Fl_Input* o, void*) {
  progStatus.dxcm_label_16=o->value();
dxc_macro_16->label(progStatus.dxcm_label_16.c_str());
progStatus.changed=true;
}

Fl_Input2 *mtext_16=(Fl_Input2 *)0;

static void cb_mtext_16(Fl_Input2* o, void*) {
  progStatus.dxcm_text_16=o->value();
progStatus.changed=true;
}
...
Fl_Double_Window* dxc_window() {
  ...
  { Fl_Double_Window* o = new Fl_Double_Window(680, 420, _("DX Cluster Spotting"));
    ...
    { Fl_Tabs* o = cluster_tabs = new Fl_Tabs(0, 78, 685, 340);
      { Fl_Group* o = tabDXclusterTelNetStream = new Fl_Group(0, 100, 680, 314, _("TelNet stream"));
        ...
        { Fl_Group* o = gp_resize_telnet = new Fl_Group(2, 102, 676, 276);
          ...
          { brws_tcpip_stream = new FTextView(4, 105, 668, 220);
          ...
          { Fl_Button* o = dxc_macro_1 = new Fl_Button(4, 328, 80, 22, _("m1"));
          ...
          { Fl_Button* o = dxc_macro_9 = new Fl_Button(5, 352, 80, 22, _("m9"));
            dxc_macro_9->tooltip(_("DX cluster macro\\nLeft click execute\\nRight click edit"));
            dxc_macro_9->callback((Fl_Callback*)dxc_click_m9);
            o->label(progStatus.dxcm_label_9.c_str());
          } // Fl_Button* dxc_macro_9
          { Fl_Button* o = dxc_macro_10 = new Fl_Button(89, 352, 80, 22, _("m10"));
            dxc_macro_10->callback((Fl_Callback*)dxc_click_m10);
            o->label(progStatus.dxcm_label_10.c_str());
          } // Fl_Button* dxc_macro_10
          { Fl_Button* o = dxc_macro_11 = new Fl_Button(173, 352, 80, 22, _("m11"));
            dxc_macro_11->callback((Fl_Callback*)dxc_click_m11);
            o->label(progStatus.dxcm_label_11.c_str());
          } // Fl_Button* dxc_macro_11
          { Fl_Button* o = dxc_macro_12 = new Fl_Button(257, 352, 80, 22, _("m12"));
            dxc_macro_12->callback((Fl_Callback*)dxc_click_m12);
            o->label(progStatus.dxcm_label_12.c_str());
          } // Fl_Button* dxc_macro_12
          { Fl_Button* o = dxc_macro_13 = new Fl_Button(341, 352, 80, 22, _("m13"));
            dxc_macro_13->callback((Fl_Callback*)dxc_click_m13);
            o->label(progStatus.dxcm_label_13.c_str());
          } // Fl_Button* dxc_macro_13
          { Fl_Button* o = dxc_macro_14 = new Fl_Button(425, 352, 80, 22, _("m14"));
            dxc_macro_14->callback((Fl_Callback*)dxc_click_m14);
            o->label(progStatus.dxcm_label_14.c_str());
          } // Fl_Button* dxc_macro_14
          { Fl_Button* o = dxc_macro_15 = new Fl_Button(509, 352, 80, 22, _("m15"));
            dxc_macro_15->callback((Fl_Callback*)dxc_click_m15);
            o->label(progStatus.dxcm_label_15.c_str());
          } // Fl_Button* dxc_macro_15
          { Fl_Button* o = dxc_macro_16 = new Fl_Button(593, 352, 80, 22, _("m16"));
            dxc_macro_16->tooltip(_("DX cluster macro\\nLeft click execute\\nRight click edit"));
            dxc_macro_16->callback((Fl_Callback*)dxc_click_m16);
            o->label(progStatus.dxcm_label_16.c_str());
      ...
      { tabDXclusterConfig = new Fl_Group(0, 100, 680, 314, _("Cluster Config"));
        tabDXclusterConfig->tooltip(_("Initialization strings for telnet cluster host"));
        { Fl_Group* o = new Fl_Group(13, 123, 475, 130);
          o->box(FL_ENGRAVED_BOX);
          { Fl_Browser* o = brws_dxcluster_hosts = new Fl_Browser(20, 142, 380, 100, _("Hosts"));
          ...
          { Fl_Group* o = new Fl_Group(405, 128, 70, 121);
            o->box(FL_ENGRAVED_BOX);
            { btn_dxcluster_hosts_select = new Fl_Button(412, 137, 54, 22, _("Select"));
            ...
            { btn_dxcluster_hosts_add = new Fl_Button(412, 165, 54, 22, _("Add"));
            ...
            { btn_dxcluster_hosts_delete = new Fl_Button(412, 193, 54, 22, _("Delete"));
            ...
            { btn_dxcluster_servers = new Fl_Button(412, 222, 54, 22, _("Srvrs"));
        ...
        { Fl_Group* o = new Fl_Group(13, 261, 475, 130);
          o->box(FL_ENGRAVED_BOX);
          { ed_telnet_cmds = new FTextEdit(20, 280, 380, 100, _("Cluster Server Setup Cmds"));
          ...
          { Fl_Group* o = new Fl_Group(405, 275, 70, 108);
            o->box(FL_ENGRAVED_BOX);
            { btn_dxcluster_hosts_load_setup = new Fl_Button(412, 282, 54, 22, _("Load"));
            ...
            { btn_dxcluster_hosts_save_setup = new Fl_Button(412, 311, 54, 22, _("Save"));
            ...
            { btn_dxcluster_hosts_send_setup = new Fl_Button(412, 340, 54, 22, _("Send"));
        ...
        { Fl_Check_Button* o = btn_spot_when_logged = new Fl_Check_Button(510, 122, 146, 15, _("Spot when logged"));
        ...
        { Fl_Check_Button* o = btn_dxc_hertz = new Fl_Check_Button(510, 145, 146, 15, _("Report [0..99 Hz]"));
      ...
      { tabDXmacros = new Fl_Group(0, 100, 680, 314, _("Macros"));
        tabDXmacros->tooltip(_("Initialization strings for telnet cluster host"));
        tabDXmacros->hide();
        { Fl_Input* o = mlabel_1 = new Fl_Input(38, 127, 75, 24, _("M 1"));
          mlabel_1->callback((Fl_Callback*)cb_mlabel_1);
          o->value(progStatus.dxcm_label_1.c_str());
        } // Fl_Input* mlabel_1
        { Fl_Input2* o = mtext_1 = new Fl_Input2(119, 127, 217, 24);
          ...
          mtext_1->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_1->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_1.c_str());
        } // Fl_Input2* mtext_1
        { Fl_Input* o = mlabel_2 = new Fl_Input(38, 160, 75, 24, _("M 2"));
          mlabel_2->callback((Fl_Callback*)cb_mlabel_2);
          o->value(progStatus.dxcm_label_2.c_str());
        } // Fl_Input* mlabel_2
        { Fl_Input2* o = mtext_2 = new Fl_Input2(119, 160, 217, 24);
        ...
        { Fl_Input* o = mlabel_3 = new Fl_Input(38, 192, 75, 24, _("M 3"));
          mlabel_3->callback((Fl_Callback*)cb_mlabel_3);
          o->value(progStatus.dxcm_label_3.c_str());
        } // Fl_Input* mlabel_3
        { Fl_Input2* o = mtext_3 = new Fl_Input2(119, 192, 217, 24);
        ...
        { Fl_Input* o = mlabel_4 = new Fl_Input(38, 224, 75, 24, _("M 4"));
          mlabel_4->callback((Fl_Callback*)cb_mlabel_4);
          o->value(progStatus.dxcm_label_4.c_str());
        } // Fl_Input* mlabel_4
        { Fl_Input2* o = mtext_4 = new Fl_Input2(119, 224, 217, 24);
        ...
        { Fl_Input* o = mlabel_5 = new Fl_Input(36, 257, 75, 24, _("M 5"));
          mlabel_5->callback((Fl_Callback*)cb_mlabel_5);
          o->value(progStatus.dxcm_label_5.c_str());
        } // Fl_Input* mlabel_5
        { Fl_Input2* o = mtext_5 = new Fl_Input2(117, 257, 217, 24);
          ...
          mtext_5->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_5->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_5.c_str());
        } // Fl_Input2* mtext_5
        { Fl_Input* o = mlabel_6 = new Fl_Input(36, 290, 75, 24, _("M 6"));
          mlabel_6->callback((Fl_Callback*)cb_mlabel_6);
          o->value(progStatus.dxcm_label_6.c_str());
        } // Fl_Input* mlabel_6
        { Fl_Input2* o = mtext_6 = new Fl_Input2(117, 290, 217, 24);
        ...
        { Fl_Input* o = mlabel_7 = new Fl_Input(36, 322, 75, 24, _("M 7"));
          mlabel_7->callback((Fl_Callback*)cb_mlabel_7);
          o->value(progStatus.dxcm_label_7.c_str());
        } // Fl_Input* mlabel_7
        { Fl_Input2* o = mtext_7 = new Fl_Input2(117, 322, 217, 24);
        ...
        { Fl_Input* o = mlabel_8 = new Fl_Input(36, 354, 75, 24, _("M 8"));
          mlabel_8->callback((Fl_Callback*)cb_mlabel_8);
          o->value(progStatus.dxcm_label_8.c_str());
        } // Fl_Input* mlabel_8
        { Fl_Input2* o = mtext_8 = new Fl_Input2(119, 354, 217, 24);
        ...
        { Fl_Input* o = mlabel_9 = new Fl_Input(380, 127, 75, 24, _("M 9"));
          mlabel_9->callback((Fl_Callback*)cb_mlabel_9);
          o->value(progStatus.dxcm_label_9.c_str());
        } // Fl_Input* mlabel_9
        { Fl_Input2* o = mtext_9 = new Fl_Input2(458, 127, 217, 24);
          mtext_9->box(FL_DOWN_BOX);
          mtext_9->color(FL_BACKGROUND2_COLOR);
          mtext_9->selection_color(FL_SELECTION_COLOR);
          mtext_9->labeltype(FL_NORMAL_LABEL);
          mtext_9->labelfont(0);
          mtext_9->labelsize(14);
          mtext_9->labelcolor(FL_FOREGROUND_COLOR);
          mtext_9->callback((Fl_Callback*)cb_mtext_9);
          mtext_9->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_9->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_9.c_str());
        } // Fl_Input2* mtext_9
        { Fl_Input* o = mlabel_10 = new Fl_Input(380, 160, 75, 24, _("M 10"));
          mlabel_10->callback((Fl_Callback*)cb_mlabel_10);
          o->value(progStatus.dxcm_label_10.c_str());
        } // Fl_Input* mlabel_10
        { Fl_Input2* o = mtext_10 = new Fl_Input2(458, 160, 217, 24);
          mtext_10->box(FL_DOWN_BOX);
          mtext_10->color(FL_BACKGROUND2_COLOR);
          mtext_10->selection_color(FL_SELECTION_COLOR);
          mtext_10->labeltype(FL_NORMAL_LABEL);
          mtext_10->labelfont(0);
          mtext_10->labelsize(14);
          mtext_10->labelcolor(FL_FOREGROUND_COLOR);
          mtext_10->callback((Fl_Callback*)cb_mtext_10);
          mtext_10->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_10->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_10.c_str());
        } // Fl_Input2* mtext_10
        { Fl_Input* o = mlabel_11 = new Fl_Input(380, 192, 75, 24, _("M 11"));
          mlabel_11->callback((Fl_Callback*)cb_mlabel_11);
          o->value(progStatus.dxcm_label_11.c_str());
        } // Fl_Input* mlabel_11
        { Fl_Input2* o = mtext_11 = new Fl_Input2(458, 192, 217, 24);
          mtext_11->box(FL_DOWN_BOX);
          mtext_11->color(FL_BACKGROUND2_COLOR);
          mtext_11->selection_color(FL_SELECTION_COLOR);
          mtext_11->labeltype(FL_NORMAL_LABEL);
          mtext_11->labelfont(0);
          mtext_11->labelsize(14);
          mtext_11->labelcolor(FL_FOREGROUND_COLOR);
          mtext_11->callback((Fl_Callback*)cb_mtext_11);
          mtext_11->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_11->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_11.c_str());
        } // Fl_Input2* mtext_11
        { Fl_Input* o = mlabel_12 = new Fl_Input(380, 224, 75, 24, _("M 12"));
          mlabel_12->callback((Fl_Callback*)cb_mlabel_12);
          o->value(progStatus.dxcm_label_12.c_str());
        } // Fl_Input* mlabel_12
        { Fl_Input2* o = mtext_12 = new Fl_Input2(458, 224, 217, 24);
          mtext_12->box(FL_DOWN_BOX);
          mtext_12->color(FL_BACKGROUND2_COLOR);
          mtext_12->selection_color(FL_SELECTION_COLOR);
          mtext_12->labeltype(FL_NORMAL_LABEL);
          mtext_12->labelfont(0);
          mtext_12->labelsize(14);
          mtext_12->labelcolor(FL_FOREGROUND_COLOR);
          mtext_12->callback((Fl_Callback*)cb_mtext_12);
          mtext_12->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_12->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_12.c_str());
        } // Fl_Input2* mtext_12
        { Fl_Input* o = mlabel_13 = new Fl_Input(380, 257, 75, 24, _("M 13"));
          mlabel_13->callback((Fl_Callback*)cb_mlabel_13);
          o->value(progStatus.dxcm_label_13.c_str());
        } // Fl_Input* mlabel_13
        { Fl_Input2* o = mtext_13 = new Fl_Input2(456, 257, 217, 24);
          mtext_13->box(FL_DOWN_BOX);
          mtext_13->color(FL_BACKGROUND2_COLOR);
          mtext_13->selection_color(FL_SELECTION_COLOR);
          mtext_13->labeltype(FL_NORMAL_LABEL);
          mtext_13->labelfont(0);
          mtext_13->labelsize(14);
          mtext_13->labelcolor(FL_FOREGROUND_COLOR);
          mtext_13->callback((Fl_Callback*)cb_mtext_13);
          mtext_13->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_13->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_13.c_str());
        } // Fl_Input2* mtext_13
        { Fl_Input* o = mlabel_14 = new Fl_Input(380, 290, 75, 24, _("M 14"));
          mlabel_14->callback((Fl_Callback*)cb_mlabel_14);
          o->value(progStatus.dxcm_label_14.c_str());
        } // Fl_Input* mlabel_14
        { Fl_Input2* o = mtext_14 = new Fl_Input2(456, 290, 217, 24);
          mtext_14->box(FL_DOWN_BOX);
          mtext_14->color(FL_BACKGROUND2_COLOR);
          mtext_14->selection_color(FL_SELECTION_COLOR);
          mtext_14->labeltype(FL_NORMAL_LABEL);
          mtext_14->labelfont(0);
          mtext_14->labelsize(14);
          mtext_14->labelcolor(FL_FOREGROUND_COLOR);
          mtext_14->callback((Fl_Callback*)cb_mtext_14);
          mtext_14->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_14->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_14.c_str());
        } // Fl_Input2* mtext_14
        { Fl_Input* o = mlabel_15 = new Fl_Input(380, 322, 75, 24, _("M 15"));
          mlabel_15->callback((Fl_Callback*)cb_mlabel_15);
          o->value(progStatus.dxcm_label_15.c_str());
        } // Fl_Input* mlabel_15
        { Fl_Input2* o = mtext_15 = new Fl_Input2(456, 322, 217, 24);
          mtext_15->box(FL_DOWN_BOX);
          mtext_15->color(FL_BACKGROUND2_COLOR);
          mtext_15->selection_color(FL_SELECTION_COLOR);
          mtext_15->labeltype(FL_NORMAL_LABEL);
          mtext_15->labelfont(0);
          mtext_15->labelsize(14);
          mtext_15->labelcolor(FL_FOREGROUND_COLOR);
          mtext_15->callback((Fl_Callback*)cb_mtext_15);
          mtext_15->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_15->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_15.c_str());
        } // Fl_Input2* mtext_15
        { Fl_Input* o = mlabel_16 = new Fl_Input(380, 354, 75, 24, _("M 16"));
          mlabel_16->callback((Fl_Callback*)cb_mlabel_16);
          o->value(progStatus.dxcm_label_16.c_str());
        } // Fl_Input* mlabel_16
        { Fl_Input2* o = mtext_16 = new Fl_Input2(456, 354, 217, 24);
          mtext_16->box(FL_DOWN_BOX);
          mtext_16->color(FL_BACKGROUND2_COLOR);
          mtext_16->selection_color(FL_SELECTION_COLOR);
          mtext_16->labeltype(FL_NORMAL_LABEL);
          mtext_16->labelfont(0);
          mtext_16->labelsize(14);
          mtext_16->labelcolor(FL_FOREGROUND_COLOR);
          mtext_16->callback((Fl_Callback*)cb_mtext_16);
          mtext_16->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          mtext_16->when(FL_WHEN_RELEASE);
          o->value(progStatus.dxcm_text_16.c_str());
        } // Fl_Input2* mtext_16
        { btn_dxcluster_ar_help = new Fl_Button(232, 385, 55, 22, _("AR ?"));
        ...
        { btn_dxcluster_cc_help = new Fl_Button(317, 385, 55, 22, _("CC ?"));
        ...
        { btn_dxcluster_dx_help = new Fl_Button(402, 385, 55, 22, _("DX ?"));
        ...
        { bx1 = new Fl_Box(38, 103, 75, 22, _("Label"));
        } // Fl_Box* bx1
        { bx2 = new Fl_Box(119, 103, 217, 22, _("Macro Text"));
        } // Fl_Box* bx2
        { bx3 = new Fl_Box(380, 103, 75, 22, _("Label"));
        } // Fl_Box* bx3
        { bx4 = new Fl_Box(458, 103, 217, 22, _("Macro Text"));
        } // Fl_Box* bx4
        tabDXmacros->end();
