...
/** \mainpage FLCLUSTER Sourcecode Interactive Doxygen Documentation : 000GIT_REVISION000
 <div align="center"><img src="fldigi-psk.png" ></div>

 \section intro Introduction

  Welcome to the FLCLUSTER Interactive Doxygen Sourcecode Documentation!
  Here you'll find information useful for developing and debugging FLCLUSTER. 
  
  FLCLUSTER - a management tool for accessing dxcluster nodes


  <BR>
  \section download To Download FLCLUSTER :
  <UL>
  <LI> To pull latest source with developer access: <B> git clone ssh://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/flcluster fldigi-flcluster</B></LI>
  <LI> To pull latest source with developer access behind proxy/firewall: <B> git clone https://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/flcluster fldigi-flcluster</B></LI>
  <LI> To pull latest source with no account, read-only: <B> git clone git://git.code.sf.net/p/fldigi/flcluster fldigi-flcluster</B></LI>
  </UL>
  ...
  <OL>
  <LI>Download the FLCLUSTER sourcecode as described above</LI>
  ...
  \section license License
 	...
 	FLCLUSTER is free software; you can redistribute it and/or modify
 	it under the terms of the GNU General Public License as published by
 	the Free Software Foundation; either version 3 of the License, or
 	(at your option) any later version.
